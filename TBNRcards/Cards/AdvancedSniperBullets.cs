...
{
    class AdvancedSniperBullets : CustomCard
    {
        ...
        {
            return "Advanced Sniper Bullets";
        }
        protected override string GetDescription()
        {
            return "Good for taking out those pesky shields, even if they suck at everything else";
        }
